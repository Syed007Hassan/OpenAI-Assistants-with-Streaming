...
load_dotenv()
assistant_id = "asst_eiokyRqN6f5WFyP6MPOOTNn1"
client = OpenAI()
...
assistant = client.beta.assistants.create(
    name="Language  Coach",
    instructions="When I ask you something in a specific language, answer me in that language and also provide me the english translation",
    model="gpt-4o")
